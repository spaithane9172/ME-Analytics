...
const Navbar = () => {
  return (
    <nav className="px-[1rem] py-[1rem] border-b-[1px] border-gray-500 flex items-center justify-between fixed w-full bg-white/5 backdrop-blur-2xl">
      <div className="flex items-center cursor-pointer">
        ...
        <h1 className="px-[1rem] text-[1.5rem] font-semibold">ME Analytics</h1>
      </div>
